  ...
  return (
    <div className="min-h-screen py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
            ...
            <div>
              <div className="flex flex-wrap gap-2 mb-3">
                {project.tags.slice(0, 3).map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1 text-xs font-medium bg-purple-500/10 text-purple-700 dark:text-purple-300 rounded-full border border-purple-500/20"
                  >
                    {tag}
                  </span>
                ))}
            ...
            <div className="flex gap-3 sm:flex-col">
              ...
              {project.githubUrl && (
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-gray-100 dark:bg-white/5 text-gray-900 dark:text-white font-medium hover:bg-gray-200 dark:hover:bg-white/10 border border-gray-300 dark:border-white/20 transition-colors whitespace-nowrap"
                >
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white/80 dark:bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 dark:border-white/10">
              ...
              <p className="text-gray-700 dark:text-gray-400 text-sm">{project.detail.problem}</p>
            </div>
            ...
            <div className="bg-white/80 dark:bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 dark:border-white/10">
              ...
              <p className="text-gray-700 dark:text-gray-400 text-sm">{project.detail.solution}</p>
            </div>
            ...
            <div className="bg-white/80 dark:bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-gray-200 dark:border-white/10">
              ...
              <p className="text-gray-700 dark:text-gray-400 text-sm">{project.detail.overview}</p>
            </div>
          </div>
        </motion.div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {project.detail.impact.map((metric, index) => (
              ...
              >
                ...
                <div className="text-sm text-gray-700 dark:text-gray-400">{metric.metric}</div>
              </motion.div>
            ))}
          </div>
        </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {project.detail.technologies.map((tech, index) => (
              <motion.div
                ...
                className="bg-white/80 dark:bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-gray-200 dark:border-white/10"
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {tech.items.map((item) => (
                    <span
                      key={item}
                      className="px-3 py-1.5 text-sm bg-gray-100 dark:bg-white/5 text-gray-800 dark:text-gray-300 rounded-lg border border-gray-300 dark:border-white/10"
                    >
                      {item}
                    </span>
                  ))}
            ...
            {project.detail.challenges.map((challenge, index) => (
              ...
              >
                ...
                <div className="space-y-4">
                  <div>
                    <div className="text-sm text-red-600 dark:text-red-400 mb-2 font-semibold">
                      Challenge
                    </div>
                    <p className="text-gray-700 dark:text-gray-400">{challenge.description}</p>
                  </div>
                  <div>
                    <div className="text-sm text-green-600 dark:text-green-400 mb-2 font-semibold">
                      Solution
                    </div>
                    <p className="text-gray-800 dark:text-gray-300">{challenge.solution}</p>
                  </div>
                </div>
              </motion.div>
            ))}
          ...
          >
            <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-2xl p-8 md:p-12 border border-purple-500/20">
              <div className="text-center max-w-3xl mx-auto">
                ...
                <blockquote className="text-xl md:text-2xl font-medium mb-6 text-gray-800 dark:text-gray-200 italic">
        ...
        >
          <div className="bg-white/80 dark:bg-white/5 backdrop-blur-sm rounded-2xl p-12 border border-gray-200 dark:border-white/10">
